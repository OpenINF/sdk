 ...
 * [`Set Iterator`](https://mdn.io/Global_Objects/Set/@@iterator).
 * @since 3.0.0
 * @category Keyed Collections
 * @param value The value to identify.
 * @returns `true` if `value` is a `Set Iterator`; else, `false`.
 */
export function isSetIterator(value: unknown): boolean {
  return isObjectLike(value) && _tagTester('Set Iterator')(value);
}
