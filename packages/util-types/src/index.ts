...
export * from './guards/is-detached-array-buffer';
...
export * from './guards/is-growable-shared-array-buffer';
...
export * from './guards/is-raw-json';
export * from './guards/is-reg-exp-string-iterator';
export * from './guards/is-resizable-array-buffer';
