...
| [`@openinf/util-types`](packages/util-types)             | Type-related predicates, including exotic and internal-slot detection          |      61 |
...
| [`@openinf/util-number`](packages/util-number)           | Integers, their sign and ranges, and Number and BigInt objects                 |      19 |
